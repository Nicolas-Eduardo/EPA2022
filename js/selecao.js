...
per1.addEventListener("click", function(){
    verificador = true;
    select.innerHTML = '<img src="css/image/patoFrente.gif" alt="Não foi possivel carregar a imagem ;-;" width="80%" height="60%"></img>';
    enemy.innerHTML = '<img src="css/image/patoCosta.gif" alt="Não foi possivel carregar a imagem ;-;" width="80%" height="60%"></img>';
